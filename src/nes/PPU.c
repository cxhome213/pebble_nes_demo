...
u32	*Buffer_scanline;				//[8 + 256 + 8];	//行显示缓存,上下标越界最大为7，显示区 7 ~ 263  0~7 263~270 为防止溢出区
...
//NES 调色板 颜色表（RGB565） 
const u32 NES_Color_Palette[64] =
{
//颜色索引地址->RGB值 -> RGB565(16bit) 
/*	0x00 -> 0x75, 0x75, 0x75 */	0x757575,    
/*	0x01 -> 0x27, 0x1B, 0x8F */	0x271B8F,    
/*	0x02 -> 0x00, 0x00, 0xAB */	0x0000AB,
/*	0x03 -> 0x47, 0x00, 0x9F */	0x47009F,
/*	0x04 -> 0x8F, 0x00, 0x77 */	0x8F0077,
/*	0x05 -> 0xAB, 0x00, 0x13 */	0xAB0013,
/*	0x06 -> 0xA7, 0x00, 0x00 */	0xA70000,
/*	0x07 -> 0x7F, 0x0B, 0x00 */	0x7F0B00,
/*	0x08 -> 0x43, 0x2F, 0x00 */	0x432F00,
/*	0x09 -> 0x00, 0x47, 0x00 */	0x004700,
/*	0x0A -> 0x00, 0x51, 0x00 */	0x005100,
/*	0x0B -> 0x00, 0x3F, 0x17 */	0x003F17,
/*	0x0C -> 0x1B, 0x3F, 0x5F */	0x1B3F5F,
/*	0x0D -> 0x00, 0x00, 0x00 */	0x000000,    
/*	0x0E -> 0x00, 0x00, 0x00 */	0x000000,    
/*	0x0F -> 0x00, 0x00, 0x00 */	0x000000,    

/*	0x10 -> 0xBC, 0xBC, 0xBC */	0xBCBCBC,     
/*	0x11 -> 0x00, 0x73, 0xEF */	0x0073EF,
/*	0x12 -> 0x23, 0x3B, 0xEF */	0x233BEF,
/*	0x13 -> 0x83, 0x00, 0xF3 */	0x8300F3,
/*	0x14 -> 0xBF, 0x00, 0xBF */	0xBF00BF,
/*	0x15 -> 0xE7, 0x00, 0x5B */	0xE7005B,
/*	0x16 -> 0xDB, 0x2B, 0x00 */	0xDB2B00,
/*	0x17 -> 0xCB, 0x4F, 0x0F */	0xCB4F0F,
/*	0x18 -> 0x8B, 0x73, 0x00 */	0x8B7300,
/*	0x19 -> 0x00, 0x97, 0x00 */	0x009700,
/*	0x1A -> 0x00, 0xAB, 0x00 */	0x00AB00,
/*	0x1B -> 0x00, 0x93, 0x3B */	0x00933B,
/*	0x1C -> 0x00, 0x83, 0x8B */	0x00838B,
/*	0x1D -> 0x00, 0x00, 0x00 */	0x000000,    
/*	0x1E -> 0x00, 0x00, 0x00 */	0x000000,    
/*	0x1F -> 0x00, 0x00, 00x0 */	0x000000,    

/*	0x20 -> 0xFF, 0xFF, 0xFF */	0xFFFFFF,    
/*	0x21 -> 0x3F, 0xBF, 0xFF */	0x3FBFFF,
/*	0x22 -> 0x5F, 0x97, 0xFF */	0x5F97FF,
/*	0x23 -> 0xA7, 0x8B, 0xFD */	0xA78BFD,
/*	0x24 -> 0xF7, 0x7B, 0xFF */	0xF77BFF,
/*	0x25 -> 0xFF, 0x77, 0xB7 */	0xFF77B7,
/*	0x26 -> 0xFF, 0x77, 0x63 */	0xFF7763,
/*	0x27 -> 0xFF, 0x9B, 0x3B */	0xFF9B3B,
/*	0x28 -> 0xF3, 0xBF, 0x3F */	0xF3BF3F,
/*	0x29 -> 0x83, 0xD3, 0x13 */	0x83D313,
/*	0x2A -> 0x4F, 0xDF, 0x4B */	0x4FDF4B,
/*	0x2B -> 0x58, 0xF8, 0x98 */	0x58F898,
/*	0x2C -> 0x00, 0xEB, 0xDB */	0x00EBDB,
/*	0x2D -> 0x00, 0x00, 0x00 */	0x000000,    
/*	0x2E -> 0x00, 0x00, 0x00 */	0x000000,    
/*	0x2F -> 0x00, 0x00, 0x00 */	0x000000,    

/*	0x30 -> 0xFF, 0xFF, 0xFF */	0xFFFFFF,    
/*	0x31 -> 0xAB, 0xE7, 0xFF */	0xABE7FF,
/*	0x32 -> 0xC7, 0xD7, 0xFF */	0xC7D7FF,
/*	0x33 -> 0xD7, 0xCB, 0xFF */	0xD7CBFF,
/*	0x34 -> 0xFF, 0xC7, 0xFF */	0xFFC7FF,
/*	0x35 -> 0xFF, 0xC7, 0xDB */	0xFFC7DB,
/*	0x36 -> 0xFF, 0xBF, 0xB3 */	0xFFBFB3,
/*	0x37 -> 0xFF, 0xDB, 0xAB */	0xFFDBAB,
/*	0x38 -> 0xFF, 0xE7, 0xA3 */	0xFFE7A3,
/*	0x39 -> 0xE3, 0xFF, 0xA3 */	0xE3FFA3,
/*	0x3A -> 0xAB, 0xF3, 0xBF */	0xABF3BF,
/*	0x3B -> 0xB3, 0xFF, 0xCF */	0xB3FFCF,
/*	0x3C -> 0x9F, 0xFF, 0xF3 */	0x9FFFF3,
/*	0x3D -> 0x00, 0x00, 0x00 */	0x000000,    
/*	0x3E -> 0x00, 0x00, 0x00 */	0x000000,    
/*	0x3F -> 0x00, 0x00, 0x00 */	0x000000     
}; 


void NES_LCD_DisplayLine(int y_axes, u32 *Disaplyline_buffer, GContext *ctx);
...
void NES_RenderLine(int y_axes, GContext *ctx)
{
	...
	//完成扫描，将行显示缓存写入LCD*/
	NES_LCD_DisplayLine(y_axes, Buffer_scanline, ctx);		 //启动LCD显示一行，查询或DMA传送
}
...
void NES_LCD_DisplayLine(int y_axes, u32 *Disaplyline_buffer, GContext *ctx)
{
	...
	for(index = 16; index < 168; index++)
	//for(index = 16; index < 256; index++)
	{
		color = Buffer_scanline[index];
		//color = 0x00EBDB;
		graphics_context_set_stroke_color(ctx, GColorFromHEX(color));
		pic_point.x = index - 16;
		graphics_draw_pixel(ctx, pic_point);
